...
//Route::get('/home', [App\Http\Controllers\HomeController::class, 'indexprod'])->name('productos');
...
Route::get('/edit/{id}', [App\Http\Controllers\ProductosController::class, 'edit']);
Route::post('/edit', [App\Http\Controllers\ProductosController::class, 'update'])->name('update');
